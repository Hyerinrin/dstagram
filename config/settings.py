...
SECRET_KEY = 'yaou-p2v#__p3+ak$5)9uhbj(7jg)3hnkx6fcra_lsk$w1g^!!'
...
DISQUS_WEBSITE_SHORTNAME = 'dstagram-hyerin' # Disqus 사이트에 작성한 이름을 써야함
SITE_ID = 1 # sites 앱에 등록된 현재 사이트의 번호, 기본적으로 1번으로 설정

AWS_ACCESS_KEY_ID = 'AKIAT3IOCK64Q7WP4XFY'
AWS_SECRET_ACCESS_KEY = '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'
AWS_REGION = 'ap-northeast-2'
AWS_STORAGE_BUCKET_NAME = 'dstagram-hyerin'
